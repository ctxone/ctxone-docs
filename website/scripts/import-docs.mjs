...
// In ctxone-docs the markdown docs live flat at the repo root
// (alongside install.sh, README.md, LICENSE), not under a docs/
// subdirectory. Differs from the CTXone monorepo layout this script
// originally lived in.
const DOCS_SRC = REPO_ROOT;
